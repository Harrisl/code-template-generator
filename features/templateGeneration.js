...
function generateFile(argFullFileName, fnGetAndReplaceFileContent, extraOption = {}) {
	return new Promise(function (resolve, reject) {
		...
		const supportedExtension = ["js", "jsx", "ts", "tsx", "vue", "gitignore", "css"],
...
function generateComponent(componentName, option = {}, extraOption = {}) {
	return new Promise((resolve, reject) => {
		...
		generateFile(
			componentName,
			function (filteredName, fileExtension) {
				...
				switch (fileExtension) {
					case "vue":
						templateName = "/vue-component.template";
						break;
...
function generateFullComponent(componentName = null, option = { subFlags: [] }) {
	return new Promise((resolve, reject) => {
		...
		if (!fs.existsSync(newFullDirectoryPath)) {
			...
			// Generate CSS file
			const generateCSSFile = generateFile(newFullCSSFileName, () => `/* CSS for ${componentName} component */`, extraOption);
